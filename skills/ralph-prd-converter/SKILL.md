...
description: Convert PRD markdown documents into prd.json for autonomous Ralph execution — atomic user stories with verifiable acceptance criteria, dependency ordering, and size constraints
---
